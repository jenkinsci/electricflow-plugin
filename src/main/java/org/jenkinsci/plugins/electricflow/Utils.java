...
public class Utils
{
    ...
    public static FormValidation validateConfiguration(String configuration) {
        ...
        try {
            ...
            log.error("Connection to CloudBees Flow Server Failed. Please fix connection information and reload this page. Error message: " + e.getMessage(), e);
            return FormValidation.error("Connection to CloudBees Flow Server Failed. Please fix connection information and reload this page. Error message: " + e.getMessage());
        }
